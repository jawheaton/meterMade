...
/**************************** Contruct PatBase  ****************************/
PatBase::PatBase(void) { columns = NULL; }

/***********************************/
void PatBase::setColumns(MeterColumn* newColumns) { columns = newColumns; }
...
// FastLED cos8
uint8_t PatBase::cos8(uint8_t theta) { return sin8(theta + 64); }
